...
var regionFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/ep/2019/strany.json', function(err, content) {
    resolve(JSON.parse(content));
  });
});
...
function processTown (nuts, town, results) {
  ...
  new Promise (function (resolve, reject) {
    ...
    var o = json.volby.eu.find(k => k.year === 2019);
...
function processNuts (nuts) {
  ...
  new Promise (function (resolve, reject) {
    fs.readFile('../zdroje/volby/ep/2019/data/' + nuts + '.xml', function(err, content) {
