...
function writeResults (json) {
  fs.writeFile("../data/volby/ep/2004/vysledky.json", JSON.stringify(json), function(err) {
...
var partiesFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/ep/2004/strany.json', function(err, data) {
    resolve(JSON.parse(data));
  });
});

var resultsFile = new Promise (function (resolve, reject) {
  fs.readFile('../zdroje/volby/ep/2004/vysledky.xml', function(err, data) {
