...
var regionFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/kv/2016/strany.json', function(err, content) {
    resolve(JSON.parse(content));
  });
});
...
function processTown (nuts, town, results) {
  ...
  new Promise (function (resolve, reject) {
    ...
    var o = json.volby.kraje.find(k => k.year === 2016);
...
function processNuts (nuts) {
  ...
  new Promise (function (resolve, reject) {
    fs.readFile('../zdroje/volby/kv/2016/data/' + nuts + '.xml', function(err, content) {
