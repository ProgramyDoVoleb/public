...
function writeResults (data) {
  fs.writeFile("../zdroje/volby/kv/2008/kzrkl_s.xml", builder.buildObject(data), function(err) {
...
var dbfFile = new Promise (function (resolve, reject) {
  fs.readFile('../zdroje/volby/kv/2008/kzrkl_s-utf8.dbf', function(err, data) {
    resolve(data);
  });
});
