...
// }, 500);
setTimeout(() => execSync('git add --all',{stdio: 'inherit'}), 1000);
setTimeout(() => execSync('git commit -a -m "' + cmsg + '"',{stdio: 'inherit'}), 1500);
setTimeout(() => execSync('git ftp push',{stdio: 'inherit'}), 2000);
