...
var regionFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/psp/2006/strany.json', function(err, content) {
    resolve(JSON.parse(content));
  });
});
...
function processTown (nuts, town, results) {
  ...
  new Promise (function (resolve, reject) {
    ...
    var o = json.volby.snemovna.find(k => k.year === 2006);
...
function processNuts (nuts) {
  ...
  new Promise (function (resolve, reject) {
    fs.readFile('../zdroje/volby/psp/2006/data/' + nuts + '.xml', function(err, content) {
