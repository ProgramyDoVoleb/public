...
function writeResults (json) {
  fs.writeFile("../data/volby/psp/2017/vysledky.json", JSON.stringify(json), function(err) {
...
var partiesFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/psp/2017/strany.json', function(err, data) {
    resolve(JSON.parse(data));
  });
});

var resultsFile = new Promise (function (resolve, reject) {
  fs.readFile('../zdroje/volby/psp/2017/vysledky.xml', function(err, data) {
