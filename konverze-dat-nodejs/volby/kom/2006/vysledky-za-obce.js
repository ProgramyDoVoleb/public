...
var resultsFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/kom/2006/vysledky.json', function(err, content) {
    resolve(JSON.parse(content));
  });
});
...
function processTown (nuts, town, result) {
  ...
  new Promise (function (resolve, reject) {
    ...
    var o = json.volby.obce.find(k => k.year === 2006);
...
function processNuts (nuts) {
  ...
  new Promise (function (resolve, reject) {
    fs.readFile('../zdroje/volby/kom/2006/data/' + nuts + '.xml', function(err, content) {
