...
function writeResults (json) {
  fs.writeFile("../data/volby/p/2013/vysledky.json", JSON.stringify(json), function(err) {
...
var candidatesFile = new Promise (function (resolve, reject) {
  fs.readFile('../data/volby/p/2013/kandidati.json', function(err, data) {
    resolve(JSON.parse(data));
  });
});

var resultsFile = new Promise (function (resolve, reject) {
  fs.readFile('../zdroje/volby/p/2013/vysledky.xml', function(err, data) {
